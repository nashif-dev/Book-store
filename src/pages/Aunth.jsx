...
function Auth({ insideRegister }) {
  ...
  return (
    <div className='w-full min-h-screen flex justify-center items-center flex-col bg-[url(/bg2.jpg)] bg-cover bg-center'>
      <div className="p-10">
        <h1 className="text-3xl font-bold text-white text-center">BOOK STORE</h1>
        <div style={{ width: '400px' }} className="bg-blue-100/75 rounded text-white p-5 flex flex-col justify-center items-center my-5">
