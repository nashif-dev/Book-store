...
function Aunth({insideRegister}) {
  ...
  return (
    <div className='w-full min-h-screen flex justify-center items-center flex-col bg-[url(/bg.jpg)] bg-cover bg-center'>
          ...
          <div style={{width:'400px'}} className="bg-black text-white p-5 flex flex-col justify-center items-center my-5">
              ...
              <form className="my-5 w-full">
                  ...
                  <div className='flex items-center'>
                    ...
                    {
                      viewPassword ?
                      <FaEyeSlash onClick={()=>setViewPassword(!viewPassword)} className='text-gray-400 cursor-pointer' style={{marginLeft:'-30px',marginTop:'-10px'}} />
                      :
                      <FaEye onClick={()=>setViewPassword(!viewPassword)} className='text-gray-400 cursor-pointer' style={{marginLeft:'-30px',marginTop:'-10px'}}/>
                    }
                    </div>
                  {/* forgot password */}
