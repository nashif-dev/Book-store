...
function Foooter() {
  return (
    <>
      <div className="container mx-auto px-4 py-12 bg-[#0D1720] text-white">
        <div className="grid grid-cols-1 md:grid-cols-3  gap-8 items-start">
          ...
          <div className="md:col-span-1">
            ...
            <input className='bg-white rounded w-75 text-black placeholder-gray-500 p-2' type="email" placeholder=' Your email'/>
            <button className='bg-orange-400 text-blue-950 p-3 rounded m-0'> <FaArrowRight/></button>
          </div>

          <div className="md:col-span-1 m-3">
            {/* Links  */}
